            ...
            function myFunction3() 
            {
               ...
               var videosource = document.getElementById('sourcevideo');
               videocontainer.pause();
               videosource.setAttribute("src", "healthform.mp4");
               videocontainer.load();
               videocontainer.play();
             ...
             function myFunction5() 
            {
               ...
               var videosource = document.getElementById('sourcevideo');
               videocontainer.pause();
               videosource.setAttribute("src", "culinary.mp4");
               videocontainer.load();
               videocontainer.play();
               document.getElementById("title").innerHTML = "Culinary Arts";       
              document.getElementById("description").innerHTML="Students will recieve instruction and participate in project-based experience in the fundamentals of safe and sanitary food handling and operation of a commercial kitchen. Students will usa e variety of cooking methods to produce entrees, salads, desserts and other dishes. Students will become familiar with the different phases involved in the operation of a restaurant, including management of a kitchen and dining area. Successful completors of this program will be prepared for related entry-level employment and/or continued education at the post-secondary level. ";
            }
             ...
             function myFunction7() 
            {
               ...
               var videosource = document.getElementById('sourcevideo');
               videocontainer.pause();
               videosource.setAttribute("src", "collision.mp4");
               videocontainer.load();
               videocontainer.play();
